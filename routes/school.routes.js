...
import { validateSchool, validateId } from '../middleware/validate.js';
 ...
 */
schoolRouter.post('/', validateSchool, async (req, res, next) => {
    try {
 ...
 */
schoolRouter.patch('/:id', validateId, validateSchool, async (req, res, next) => {
    try {
 ...
 */
schoolRouter.delete('/:id', validateId, async (req, res, next) => {
    try {
